  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[#09090b] px-4 py-10 sm:px-6 lg:px-8">
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute left-1/2 top-0 h-72 w-72 -translate-x-1/2 rounded-full bg-violet-600/30 blur-3xl" />
      ...
      <div className="glass-panel relative w-full max-w-md p-8 sm:p-10">
        ...
        <div className="mt-6 flex items-center justify-center gap-2 rounded-2xl border border-white/10 bg-white/5 px-3 py-3 text-sm text-zinc-400">
          <LockKeyhole className="h-4 w-4 text-violet-300" />
          Secured with JWT and encrypted credentials.
        </div>

        <p className="mt-6 text-center text-sm text-zinc-400">
          New to Northstar?{' '}
          <Link href="/register" className="font-semibold text-violet-300 transition hover:text-white">
            Create account
          </Link>
        </p>
      </div>
